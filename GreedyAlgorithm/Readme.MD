...
Dessa forma, o algoritimo inicia com uma função, (<i>Readi<i>), para ler o arquivo de matrizes e armazená-las em um vector. As demais funções são chamadas dentro dessa função também, sendo elas:
